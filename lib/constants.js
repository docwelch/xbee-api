...
exports.FRAME_TYPE_SETS = {
  ...
  "DigiMesh": [0x08,0x09,0x10,0x11,0x17,0x88,0x8A,0x8B,0x8D,0x8E,0x90,0x91,0x92,0x95,0x97]
};
...
ft.ROUTE_INFORMATION_PACKET = 0x8D;
ft[0x8D] = "Route Information Packet (0x8D)";
ft.AGGREGATE_ADDRESSING_UPDATE = 0x8E;
ft[0x8E] = "Aggregate Addressing Update (0x8E)";
