...
frame_parser[C.FRAME_TYPE.ROUTE_INFORMATION_PACKET] = function(frame, reader) {
  frame.id = reader.nextUInt8();
  frame.srcEvent = reader.nextUInt8();
  frame.lngth = reader.nextUInt8();
  frame.timestamp = reader.nextString(4, 'hex');
  frame.ackTimeoutCount = reader.nextUInt8();
  frame.reserved = reader.nextString(2, 'hex');
  frame.destination64 = reader.nextString(8, 'hex');
...
frame_parser[C.FRAME_TYPE.AGGREGATE_ADDRESSING_UPDATE] = function(frame, reader) {
  frame.id = reader.nextUInt8();
  frame.format = reader.nextUInt8();
